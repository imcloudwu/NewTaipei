...
class PrepareViewCtrl: UIViewController {
                ...
                dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_BACKGROUND, 0), {
                    ...
                    dispatch_async(dispatch_get_main_queue(), {
                        ...
                        if self.Success{
                            ...
                            NotificationService.Register(Global.AccessToken) { () -> () in
    ...
    func GetMyAccountInfo(){
        ...
        if let data = try? HttpClient.Get("https://auth.ntpc.edu.tw/services/me.php?access_token=\(Global.AccessToken)"){
