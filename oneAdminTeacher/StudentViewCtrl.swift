...
//            }
    ...
    func GetClassStudentData() -> [Student]{
        ...
        let rsp = _con.SendRequest("main.GetClassStudents", bodyContent: "<Request><All></All><ClassID>\(ClassData.ID)</ClassID></Request>", &err)
...
//    }
    ...
    func SendMessageToClassParents(cell : StudentCell){
        ...
        let rsp = con.sendRequest("main.GetParent", bodyContent: "<Request><StudentID>\(cell.student.ID)</StudentID></Request>", &err)
        ...
        if err != nil{
            ...
            if let parents = xml?.root["Response"]["Parent"].all {
                for parent in parents{
                    ...
                    let pa = TeacherAccount(schoolName: "", name: studentName + "(" + relationship + ")", account: parentAccount)
