    ...
    func searchBar(searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        if searchText == "" {
            ...
            let founds = DataBase.filter({ t in
                ...
                if let _ = t.Name.lowercaseString.rangeOfString(searchText.lowercaseString){
                    return true
                }
                else if let _ = t.Account.lowercaseString.rangeOfString(searchText.lowercaseString){
                    return true
                }
