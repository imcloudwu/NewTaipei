...
public class OAuthHelper {
    ...
    static let ServiceAuthorize: String = "https://auth.ntpc.edu.tw/oauth/authorize.php"
    
    static let ServiceExchangeAccessToken: String = "https://auth.ntpc.edu.tw/oauth/token.php"
    
    static let ServiceME: String = "https://auth.ntpc.edu.tw/services/me.php"
    ...
    init(clientId cid: String, clientSecret cs: String, redirectUrl ru: String = "http://localhost:3000/oauth/ntpc_callback", scope s: String = "User.Mail,User.BasicInfo,1Campus.Notification.Read,1Campus.Notification.Send,*:sakura") {
        self.client_id = cid
